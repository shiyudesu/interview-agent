...
- [x] 6.6 Build evaluation fixtures covering correct, partially correct, incorrect, unknown, skipped, irrelevant, ambiguous, and prompt-injection-style answers.
- [x] 6.7 Add Faux Provider tests for output validation, retry exhaustion, fallback wording, evidence references, and state-preserving failure behavior.
...
- [x] 7.2 Add `/api/v1` command endpoints requiring Idempotency Keys and expected interview versions, with stable conflict and retryable-error responses.
...
- [x] 9.3 Implement interview creation with the fixed Go backend direction, 5/10/15 question selection, and active-interview resume-or-abandon conflict flow.
...
- [x] 9.9 Add React Testing Library coverage for critical forms, interview actions, report rendering, and deletion states.
